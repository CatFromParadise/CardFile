...
namespace DAL.Contexts
{
    ...
    {
        //TODO:Uncomment this lines if you want to create new Migration.
        //HINT! Don't forget to comment AppDbContext with parameters

        public AppDbContext() { }
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseSqlServer(@"Server=DESKTOP-D3J0VVB;Database=CardFileDb;Trusted_Connection=True;");
        }
